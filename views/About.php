...
<div id="about_top">
    ...
    <div id="about_top_intro">
        ...
        <p>After finishing school in 2010, I have tried different professional areas, and my goal has always been to find something that I could really enjoy doing and to become good at it. So far I have managed to collect a lot of data about myself, life in general, existence itself, my role in it and what is it that I really want to do in my life.</p>
        <p>At some point, when everything else had failed, I realized that, given my skill set, web development is the only option left that makes sense for me to focus on. And since I joined Free Code Camp, on October 10, 2016, and started to learn coding, I am absolutely sure, that this is exactly what I want to do and can be good at, my "final triumph".</p>
